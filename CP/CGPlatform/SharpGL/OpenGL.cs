...
namespace SharpGL
{
	...
	//   WIN_specular_fog 
		...
		public const string LIBRARY_OPENGL = lib_OGL;
    ...
    [DllImport(LIBRARY_OPENGL, SetLastError = true)] private static extern void glDrawPixels(int width, int height, uint format, uint type, IntPtr pixels);
		...
		internal const string LIBRARY_GLU = lib_GLU;
...
//		[DllImport(LIBRARY_GLU, SetLastError = true)] private static extern void  gluTessCallback(IntPtr tess, int which, SharpGL.Delegates.Tesselators.VertexData callback);
        ...
        /// <param name="stride">Specifies the byte offset between consecutive colors. If stride is 0, (the initial value), the colors are understood to be tightly packed in the array.</param>
        /// <param name="pointer">Specifies a pointer to the first component of the first color element in the array.</param>
        public virtual void ColorPointer(int size, int stride, short[] pointer)
        {
            PreGLCall();
        ...
        /// <param name="stride">Specifies the byte offset between consecutive colors. If stride is 0, (the initial value), the colors are understood to be tightly packed in the array.</param>
        /// <param name="pointer">Specifies a pointer to the first component of the first color element in the array.</param>
        public virtual void ColorPointer(int size, int stride, int[] pointer)
        {
            PreGLCall();
        ...
        /// <param name="stride">Specifies the byte offset between consecutive colors. If stride is 0, (the initial value), the colors are understood to be tightly packed in the array.</param>
        /// <param name="pointer">Specifies a pointer to the first component of the first color element in the array.</param>
        public virtual void ColorPointer(int size, int stride, float[] pointer)
        {
            PreGLCall();
        ...
        /// <param name="stride">Specifies the byte offset between consecutive colors. If stride is 0, (the initial value), the colors are understood to be tightly packed in the array.</param>
        /// <param name="pointer">Specifies a pointer to the first component of the first color element in the array.</param>
        public unsafe virtual void ColorPointer(int size, int stride, float* pointer)
        {
            PreGLCall();
        ...
        /// <param name="stride">Specifies the byte offset between consecutive colors. If stride is 0, (the initial value), the colors are understood to be tightly packed in the array.</param>
        /// <param name="pointer">Specifies a pointer to the first component of the first color element in the array.</param>
        public virtual void ColorPointer(int size, int stride, double[] pointer)
        {
            PreGLCall();
        ...
        /// <param name="stride">Specifies the byte offset between consecutive colors. If stride is 0, (the initial value), the colors are understood to be tightly packed in the array.</param>
        /// <param name="pointer">Specifies a pointer to the first component of the first color element in the array.</param>
        public unsafe virtual void ColorPointer(int size, int stride, double* pointer)
        {
            PreGLCall();
    ...
    /// <param name="nurbsObject">The nurbs object.</param>
		...
		public virtual void LoadMatrix( double []m)
        {
            PreGLCall();
            glLoadMatrixd(m);
            PreGLCall();
		...
		/// </summary>
		/// <param name="mode">The mode, normally PROJECTION or MODELVIEW.</param>
        public virtual void MatrixMode(Enumerations.MatrixMode mode)
		{
			PreGLCall();
        ...
        /// <param name="stride">The space in bytes between each normal.</param>
        /// <param name="pointer">The normals.</param>
        public virtual void NormalPointer(int stride, short[] pointer)
        {
            PreGLCall();
        ...
        /// <param name="stride">The space in bytes between each normal.</param>
        /// <param name="pointer">The normals.</param>
        public virtual void NormalPointer(int stride, int[] pointer)
        {
            PreGLCall();
        ...
        /// <param name="stride">The space in bytes between each normal.</param>
        /// <param name="pointer">The normals.</param>
        public virtual void NormalPointer(int stride, float[] pointer)
        {
            PreGLCall();
        ...
        /// <param name="stride">The space in bytes between each normal.</param>
        /// <param name="pointer">The normals.</param>
        public unsafe virtual void NormalPointer(int stride, float* pointer)
        {
            PreGLCall();
        ...
        /// <param name="stride">The space in bytes between each normal.</param>
        /// <param name="pointer">The normals.</param>
        public virtual void NormalPointer(int stride, double[] pointer)
        {
            PreGLCall();
        ...
        /// <param name="stride">The space in bytes between each normal.</param>
        /// <param name="pointer">The normals.</param>
        public unsafe virtual void NormalPointer(int stride, double* pointer)
        {
            PreGLCall();
    ...
    /// <param name="type">The type of data to generate.</param>
        ...
        /// <param name="stride">The byte offset between vertices.</param>
        /// <param name="pointer">The array.</param>
        public virtual void VertexPointer(int size, int stride, short[] pointer)
        {
            PreGLCall();
        ...
        /// <param name="stride">The byte offset between vertices.</param>
        /// <param name="pointer">The array.</param>
        public virtual void VertexPointer(int size, int stride, int[] pointer)
        {
            PreGLCall();
        ...
        /// <param name="stride">The byte offset between vertices.</param>
        /// <param name="pointer">The array.</param>
        public virtual void VertexPointer(int size, int stride, float[] pointer)
        {
            PreGLCall();
        ...
        /// <param name="stride">The byte offset between vertices.</param>
        /// <param name="pointer">The array.</param>
        public virtual unsafe void VertexPointer(int size, int stride, float* pointer)
        {
            PreGLCall();
        ...
        /// <param name="stride">The byte offset between vertices.</param>
        /// <param name="pointer">The array.</param>
        public virtual void VertexPointer(int size, int stride, double[] pointer)
        {
            PreGLCall();
        ...
        /// <param name="stride">The byte offset between vertices.</param>
        /// <param name="pointer">The array.</param>
        public virtual unsafe void VertexPointer(int size, int stride, double* pointer)
        {
            PreGLCall();
