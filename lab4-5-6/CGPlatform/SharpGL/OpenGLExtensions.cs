...
namespace SharpGL
{
    public unsafe partial class OpenGL
    {
        ...
        private T GetDelegateFor<T>() where T : class
        {
            ...
            if (extensionFunctions.TryGetValue(name, out del) == false)
            {
                ...
                if (Environment.OSVersion.Platform == PlatformID.Unix ||
                    ...
                    proc = Win32.glXGetProcAddress(name);
                } else {
        ...
        private delegate void glGenBuffers (int n, IntPtr buffers);
        ...
        private delegate void glGenVertexArrays(int n, IntPtr arrays);
