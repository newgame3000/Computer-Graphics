	...
	public static class Win32
	{
        ...
        static Win32()
        {
            ...
            //IntPtr glLibrary = Win32.LoadLibrary(OpenGL32);
              IntPtr glLibrary = DynLoad.dlopen(OpenGL32, DynLoad.RTLD.NOW | DynLoad.RTLD.DEEPBIND);
          //  Debug.Assert(glLibrary != null);
            return;
        }
        
        //  The names of the libraries we're importing.
		public const string Kernel32 = "kernel32.dll";
		public const string OpenGL32 = OpenGL.LIBRARY_OPENGL;
		public const string Glu32 = OpenGL.LIBRARY_GLU;
